...
namespace QLKS.Areas.Admin.Controllers.Admin
{
    public class HoaDonController : Controller
    {
        ...
        // GET: HoaDon
        public ActionResult Index() // return index.cshtml
        {
            var tblHoaDons = 
            ...
            ViewBag.tong_tien = String.Format("{0:0,0.00}", tong); // {0,0:C2}
            return View(tblHoaDons.ToList());
        }

        [HttpPost]
        public ActionResult Index(String beginDate, String endDate) // enabled when you need search
        {
        ...
        public ActionResult Details(int? id) // already available
        {
            if (id == null)
            {
        ...
        // GET: HoaDon/Create
        public ActionResult Create() // already available
        {
        ...
        public ActionResult Create([Bind(Include = "ma_hd,ma_pdp,ngay_tra_phong,ma_tinh_trang")] tblHoaDon tblHoaDon) // already available
        {
        ...
        public ActionResult Add(int? id) // return Add.cshtml
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
        ...
        // GET: HoaDon/Edit/5
        public ActionResult Edit(int? id) // already available
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ma_hd,ma_nv,ma_pdp,ngay_tra_phong,ma_tinh_trang,tien_phong,tien_dich_vu,phu_thu,tong_tien")] tblHoaDon tblHoaDon) // already available
        {
            if (ModelState.IsValid)
            {
        ...
        // GET: HoaDon/Delete/5
        public ActionResult Delete(int? id) // already available
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
        ...
        [ValidateAntiForgeryToken]
        public ActionResult DeleteConfirmed(int id) // already available
        {
            tblHoaDon tblHoaDon = db.tblHoaDons.Find(id);
        ...
        public ActionResult Result(String ma_pdp,String hoten1,String hoten2,String hoten3,String hoten4,String tuoi1,String tuoi2,String tuoi3,String tuoi4) // return Result.cshtml: đặt phòng thành công
        {
            if (ma_pdp == null)
            {
        ...
        public ActionResult ThanhToan(int? id) // return ThanhToan.cshtml
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
        ...
        public ActionResult GoiDichVu(int? id) // return DichVu.cshtml
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
        ...
        public ActionResult XacNhanGoiDichVu(String ma_hd, String ma_dv, String so_luong) // returned from GoiDichVu.cshtml
        {
        ...
        public ActionResult SuaDichVu(String ma_hd, String edit_id, String edit_so_luong) // returned from GoiDichVu.cshtml
        {
            ...
            int del = (int)(sol - dsdv.so_luong); // chenh lech con so nhap vao vs con so hien co
        ...
        public ActionResult XoaDichVu(String ma_hd, String del_id) // returned from GoiDichVu
        {
        ...
        public ActionResult XacNhanThanhToan(String ma_hd, String tien_phong, String tien_dich_vu,String phu_thu, String tong_tien) // return XacNhanThanhToan.cshtml
        {
        ...
        public ActionResult GiaHanPhong(int? id) // return GiaHanPhong.cshtml
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
            ...
            try
            {
                DateTime d = (DateTime)db.tblPhieuDatPhongs.Where(t => t.ma_tinh_trang == 1 && t.ma_phong == pdp.tblPhong.ma_phong)
                    .Select(t => t.ngay_vao).OrderBy(t => t.Value).First();
                dt = d.ToString("dddd, dd MMMM yyyy");
            }
            catch
            {
        ...
        public ActionResult ResultGiaHan(String ma_pdp,String ngay_ra) // return ResultGiaHan.cshtml
        {
        ...
        public ActionResult DoiPhong(int? id) // return DoiPhong.cshtml
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
            ...
            var li = db.tblPhongs.Where(t => t.ma_tinh_trang==1 && 
            !(db.tblPhieuDatPhongs.Where(m => (m.ma_tinh_trang == 1 || m.ma_tinh_trang == 2) && 
            m.ngay_ra > DateTime.Now && m.ngay_vao < pdp.ngay_ra)).
            Select(m => m.ma_phong).ToList().Contains(t.ma_phong));

            ViewBag.ma_phong_moi = new SelectList(li, "ma_phong", "so_phong");
            return View(pdp);
        }

        public ActionResult ResultDoiPhong(String ma_pdp,String ma_phong_cu, String ma_phong_moi) // return ResultDoiPhong.cshtml
        {
            ...
            {
                tblPhieuDatPhong pdp = db.tblPhieuDatPhongs.Find(Int32.Parse(ma_pdp));
                tblPhong p = db.tblPhongs.Find(pdp.tblPhong.ma_phong);      // get info of old room
                p.ma_tinh_trang = 3;                                       // old room sang Dang don
                db.Entry(p).State = EntityState.Modified;
                pdp.ma_phong = Int32.Parse(ma_phong_moi);                   // set old to new
                p = db.tblPhongs.Find(Int32.Parse(ma_phong_moi));           // get info of new room
                p.ma_tinh_trang = 2;                                        
                db.Entry(p).State = EntityState.Modified;
