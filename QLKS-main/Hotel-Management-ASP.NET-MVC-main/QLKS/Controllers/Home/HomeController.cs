...
namespace QLKS.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult About() // return About.cshtml
        {
        ...
        public ActionResult Contact() // return Contact.cshtml
        {
        ...
        */
        [HttpGet]
        public ActionResult FindRoom() // return FindRoom.cshtml
        {
            return RedirectToAction("Index", "Home");
        }
        [HttpPost]
        public ActionResult FindRoom(String datestart, String dateend) // submited from FindRoom.cshtml
        {
        ...
        public ActionResult ChonPhong(string id) // API - Ajax
        {
            //Session["ma_phong"] = id;
            try
            {
        ...
        public ActionResult HuyChon(string id) // API - Ajax
        {
            try
            {
                List<int> ds;
        ...
        public ActionResult BookRoom() // return BookRoom.cshtml
        {
            if (Session["KH"] == null)
            {
            ...
            if (ds == null)
                ds = new List<int>();
            ViewBag.ma_phong = JsonConvert.SerializeObject(ds); // serialize the obeject to json
        ...
        public ActionResult Result(String ma_kh, String ngay_vao, String ngay_ra, String ma_phong) // return Result.cshtml
        {
            ...
            else
            {
                ...
                List<int> ds = JsonConvert.DeserializeObject<List<int>>(ma_phong); // from json to list c# object
                tgd.ma_kh = ma_kh;
                tgd.ma_tinh_trang = 1;
        ...
        public ActionResult HuyPhieuDatPhong() // at BookRoom.cshtml
        {
            setNull();
            return RedirectToAction("BookRoom", "Home");
        }
